...
/** Fabric entry point for the shared cross-version player lifecycle bridge. */
public final class FabricPlayerLifecyclePort implements PlayerLifecyclePort {
    ...
    @Override
    public boolean perform(String dimension, UUID playerId, com.dwurdy.heaphammer.domain.PlayerAction action,
