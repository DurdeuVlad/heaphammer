...
/**
 * Bridge interface decoupling ForgeChunkManager operations from specific MinecraftForge 1.7.10 runtime jars.
 * This allows HeapHammer to run unit tests and portable analysis without requiring
 * Forge 1.7.10 / CleanroomMC build classpath dependencies during compilation.
 */
public interface ForgeTicketBridge1710 {
