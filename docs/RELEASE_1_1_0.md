...
The canonical Fabric 1.21.1 build packages two additional opt-in fixtures for validating the new evidence paths:
...
These fixtures are intentionally gated to the root 1.21.1 Fabric build. Historical Fabric branches, NeoForge, and legacy Forge need separate adaptations before their CI matrices can claim equivalent fixture coverage.
