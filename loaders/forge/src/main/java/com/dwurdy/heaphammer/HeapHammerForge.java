...
import com.dwurdy.heaphammer.command.ForgeHeapHammerCommands;
...
/**
 * MinecraftForge 1.16.5 entry point. Mirrors the Fabric {@code HeapHammer}
...
public class HeapHammerForge {
	...
	private final ForgeHeapHammerCommands commands;
	...
	public HeapHammerForge() {
		...
		this.commands = new ForgeHeapHammerCommands(
				platform,
				experimentService,
				checkpointService,
				planStorage,
